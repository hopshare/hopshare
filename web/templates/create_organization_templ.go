...
func CreateOrganizationBody(orgName string, city string, state string, description string, successMsg string, errorMsg string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 6, "<form class=\"space-y-4\" method=\"POST\" action=\"/organizations/create\" enctype=\"multipart/form-data\" x-data=\"{\n\t\t\t\tlogoChanged: false,\n\t\t\t\tlogoName: '',\n\t\t\t\tlogoPreview: '',\n\t\t\t\thandleLogoChange(e) {\n\t\t\t\t\tconst f = e.target.files && e.target.files[0];\n\t\t\t\t\tif (!f) {\n\t\t\t\t\t\tthis.logoChanged = false;\n\t\t\t\t\t\tthis.logoName = '';\n\t\t\t\t\t\tthis.logoPreview = '';\n\t\t\t\t\t\treturn;\n\t\t\t\t\t}\n\t\t\t\t\tthis.logoChanged = true;\n\t\t\t\t\tthis.logoName = f.name;\n\t\t\t\t\tconst reader = new FileReader();\n\t\t\t\t\treader.onload = () => { this.logoPreview = reader.result; };\n\t\t\t\t\treader.readAsDataURL(f);\n\t\t\t\t},\n\t\t\t}\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `web/templates/create_organization.templ`, Line: 47, Col: 184}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `web/templates/create_organization.templ`, Line: 52, Col: 173}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `web/templates/create_organization.templ`, Line: 56, Col: 176}
		}
